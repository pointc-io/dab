...
@observer
export class UtApp extends React.Component<TodoAppProps, TodoAppState> {
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="pt-non-ideal-state pt-dark" style={{marginTop: '25px'}}>
          <div className="pt-non-ideal-state-visual pt-non-ideal-state-icon">
            <span className="pt-icon pt-icon-folder-open"></span>
          </div>
          <h4 className="pt-non-ideal-state-title">No Fingerprints</h4>
